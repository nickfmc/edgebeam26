...
$hero_has_bg      = ! empty( $featured_img_url );
$hero_style_attr  = $hero_has_bg
    ? ' style="background-image: url(' . esc_url( $featured_img_url ) . '); background-position: center ' . esc_attr( $hero_bg_position ) . ';"'
    : '';
$hero_classes     = 'o-layout-row c-blog-header' . ( $hero_has_bg ? ' has-featured-bg' : '' );
?>

<div class="<?php echo esc_attr( $hero_classes ); ?>"<?php echo $hero_style_attr; ?>>
  <?php if ( $hero_has_bg ) : ?>
  <div class="c-blog-header__overlay" aria-hidden="true"></div>
  <?php endif; ?>
